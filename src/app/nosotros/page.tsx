...
const AboutUsPage = () => {
	return (
		<>
			...
			<main className="container flex flex-col mt-0 mb-20 sm:mt-20 sm:mb-20 max-w-[1200px] mx-auto ">
				<section className="my-40 sm:my-20 flex flex-col-reverse md:flex-row md:justify-center md:items-center gap-10 sm:min-h-[90vh]">
					...
					<div className="flex flex-col md:max-w-xl w-full">
						...
						<p className="text-lg sm:text-lg text-justify md:text-start md:text-xl md:max-w-2xl font-roboto font-thin text-foreground/60 w-full mb-2">
							En More than Books, nos comprometemos a satisfacer las necesidades de las
							instituciones educativas con eficiencia y eficacia.
						</p>
						<p className="text-lg sm:text-lg text-justify md:text-start md:text-xl md:max-w-2xl font-roboto font-thin text-foreground/60 w-full">
				...
				<section className="mb-16 flex flex-col md:flex-row md:justify-center md:items-center sm:gap-10 pt-12 pb-6 sm:py-10 rounded-3xl bg-orange-100/70 px-6">
					<div className="flex flex-col md:max-w-[50%] lg:max-w-xl w-full items-center">
						...
						<p className="text-lg text-justify md:text-start md:text-xl md:max-w-2xl font-roboto font-thin text-foreground/60 w-full mb-2">
						...
						<p className="text-lg text-justify md:text-start md:text-xl md:max-w-2xl font-roboto font-thin text-foreground/60 w-full">
