				...
				<header className="bg-primary w-full relative z-0 mb-20 ">
					...
					<div className="z-[2] text-white container flex flex-col items-center justify-start pt-28 sm:pt-36 min-h-[50rem] md:min-h-screen md:pt-56 w-full xl:pb-96 xl:min-h-[auto] pb-0 sm:pb-52 relative">
						<h1
							...
							className="text-5xl sm:text-7xl font-bold text-center px-2 max-w-[25ch] font-roboto"
						>
						...
						<p
							...
							data-aos-duration="600"
							className="text-xl md:text-2xl font-roboto font-thin text-center mt-4 px-2"
						>
				...
				<div className="pt-48 sm:pt-20 sm:pb-20 mb-20">
					<div className="container mx-auto px-4">
						<div className="text-center mb-12">
							...
							>
								¿Por qué elegir More than Books?
							</h2>
							<p
								data-aos="fade-up"
								data-aos-duration="600"
							...
							>
								Descubre por qué More than Books es el aliado perfecto para tus necesidades
								educativas
							</p>
						</div>
						<div className="flex justify-center flex-wrap gap-6 md:max-w-[1200px] md:mx-auto">
							<div
								...
								data-aos-delay="100"
								data-aos-offset="200"
								className="bg-white p-6 rounded-3xl shadow-xl text-center w-full max-w-96"
							>
				...
				<section className="container my-40 sm:my-20 flex flex-col-reverse md:flex-row md:justify-center md:items-center gap-10 sm:min-h-[90vh]">
					...
					<div className="flex flex-col md:max-w-xl w-full items-center md:items-start">
						<p
							...
							data-aos-delay="100"
							data-aos-offset="150"
							className="w-fit px-6 py-1 bg-primary/10 text-primary rounded-full mb-2 text-sm font-roboto font-thin"
						>
							Blog
						</p>
						<h2
						...
						<p
							...
							data-aos-delay="300"
							data-aos-offset="150"
							className="text-base sm:text-lg text-center md:text-start md:text-xl md:max-w-2xl font-roboto font-thin text-foreground/60 w-full mb-2"
						>
						...
						<p
							...
							data-aos-delay="400"
							data-aos-offset="150"
							className="text-base sm:text-lg text-center md:text-start md:text-xl md:max-w-2xl font-roboto font-thin text-foreground/60 w-full"
						>
							Nuestro blog está diseñado para apoyar a profesores, estudiantes y todos los
				...
				<section className="container my-40 sm:my-20 flex flex-col-reverse md:flex-row md:justify-center md:items-center gap-10 sm:min-h-[90vh]">
					...
					<div className="flex flex-col md:max-w-xl w-full items-center md:items-start">
						<p
							...
							data-aos-delay="100"
							data-aos-offset="150"
							className="w-fit sm:mx-0 px-6 py-1 bg-indigo-500/10 text-indigo-500 rounded-full mb-2 text-sm font-roboto font-thin"
						>
							Eventos
						</p>
						<h2
				...
				<section className="container my-40 sm:mt-20 sm:mb-0 flex flex-col md:flex-row gap-6 md:gap-10 sm:min-h-[90vh] relative">
					<div className="flex flex-col w-full">
						...
						<p
							...
							data-aos-delay="0"
							data-aos-offset="150"
							className="w-fit mx-auto px-6 py-1 bg-teal-500/10 text-teal-500 rounded-full mb-2 text-sm font-roboto font-thin"
						>
							FQA
						</p>
						<h2
						...
						<p
							...
							data-aos-delay="200"
							data-aos-offset="150"
							className="text-base sm:text-lg text-center md:text-xl md:max-w-2xl font-roboto font-thin text-foreground/60 w-full mb-2"
						>
